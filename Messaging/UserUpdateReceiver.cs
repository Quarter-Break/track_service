...
namespace TrackService.Messaging
{
    public class UserUpdateReceiver : BackgroundService
    {
        ...
        public UserUpdateReceiver(IOptions<RabbitMqConfiguration> rabbitMqOptions)
        {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += (ch, ea) =>
            {
                ...
                var updateUserModel = JsonConvert.DeserializeObject<UserModel>(content);

                HandleMessage(updateUserModel);
        ...
        private void HandleMessage(UserModel updateUserModel)
        {
